CREATE TABLE users (
                       ...
                       document_number VARCHAR2(18) NOT NULL UNIQUE,
        ...
        CONSTRAINT chk_investor_level
        CHECK (investor_level IN ('iniciante', 'moderado', 'avancado', 'profissional')),
...
CREATE TABLE accounts (
                          ...
                          CONSTRAINT uq_user_default_account UNIQUE (user_id, is_default)
);
