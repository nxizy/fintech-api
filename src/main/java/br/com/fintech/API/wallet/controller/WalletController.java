package br.com.fintech.API.wallet.controller; // Caminho atualizado

// Imports dos DTOs e Service com caminhos atualizados
...
@RestController
@RequestMapping("/accounts") // A URL base ainda é /accounts
